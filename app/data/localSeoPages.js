export default {
    kfzGutachtenBonn: {
        ...
        image: '/img/generated/leistung-2-1440.webp',
        ...
        sections: [
            {
                ...
                bullets: [
                    ...
                    'Oldtimer-Gutachten und Beratung rund um das H-Kennzeichen',
                    'Gutachten für Elektrofahrzeuge und moderne Fahrzeugtechnik',
                ],
            },
            {
                id: 'wertgutachten',
                title: 'Wertgutachten mit nachvollziehbarer Einschätzung',
                text: 'Ein Wertgutachten hilft, den Marktwert eines Fahrzeugs belastbar einzuordnen. Das ist besonders hilfreich bei Verkauf, Versicherung, Finanzierung, Leasingrückgabe oder Streitfällen.',
            },
            {
                id: 'oldtimer',
                title: 'Oldtimer-Gutachten in Bonn',
                text: 'Klassische Fahrzeuge brauchen eine sorgfältige Bewertung von Originalität, Zustand und Marktumfeld. Wir unterstützen bei Oldtimern, Youngtimern und Fragen zum H-Kennzeichen.',
            },
            {
                id: 'elektroauto',
                title: 'Gutachten für Elektrofahrzeuge',
                text: 'Elektrofahrzeuge stellen eigene Anforderungen an Prüfung und Dokumentation. Wir berücksichtigen die Besonderheiten moderner Antriebe und Fahrzeugtechnik.',
            },
            {
                id: 'beratung',
                title: 'Persönliche Beratung im Prüfbüro',
                text: 'Sie finden uns in der Siemensstr. 1 in Bonn. Für viele Anliegen reicht ein kurzer Anruf, um den passenden nächsten Schritt zu klären.',
            },
        ],
        services: [
            { name: 'Kfz Gutachten Bonn', description: 'Sachverständige Fahrzeugbegutachtung in Bonn.' },
            { name: 'Wertgutachten', description: 'Bewertung von Marktwert und Fahrzeugzustand.' },
            { name: 'Oldtimer-Gutachten', description: 'Gutachten für Klassiker, Youngtimer und H-Kennzeichen.' },
            { name: 'e-Auto Gutachten', description: 'Gutachten für Elektrofahrzeuge und moderne Fahrzeugtechnik.' },
        ],
        faq: [
            {
                question: 'Wann brauche ich ein Kfz Gutachten?',
            ...
            {
                question: 'Kann ich vorab telefonisch klären, welches Gutachten passt?',
                answer: 'Ja. Sie erreichen uns telefonisch unter 0228-96699180 oder mobil unter 01573-7154376.',
            },
        ],
        breadcrumbs: [
            { name: 'Startseite', path: '/' },
            { name: 'Kfz Gutachten Bonn', path: '/kfz-gutachten-bonn/' },
        ],
    },
    unfallgutachtenBonn: {
        ...
        image: '/img/generated/unfallgutachten-810-810.webp',
        ...
        sections: [
            {
                ...
                bullets: [
                    ...
                    'Gutachten für Pkw, Lkw, Motorrad und Wohnmobil',
                    'Direkter Kontakt für Rückfragen zur Regulierung',
                ],
            },
            {
                id: 'kosten',
                title: 'Kosten bei unverschuldetem Unfall',
                text: 'Bei einem unverschuldeten Unfall werden die Gutachterkosten in der Regel von der gegnerischen Versicherung übernommen. Wir erklären Ihnen vorab, welcher Weg in Ihrem Fall sinnvoll ist.',
            },
            {
                id: 'bagatellschaden',
                title: 'Bagatellschaden oder Gutachten?',
                text: 'Bei sehr kleinen Schäden kann ein Kostenvoranschlag ausreichen. Wenn Schadenhöhe, Wertminderung oder Beweissicherung eine Rolle spielen, ist ein Gutachten oft die bessere Grundlage.',
            },
        ],
        services: [
            { name: 'Unfallgutachten Bonn', description: 'Gutachten und Beweissicherung nach einem Kfz Unfall.' },
            { name: 'Schadengutachten', description: 'Dokumentation von Schadenhöhe, Reparaturweg und Wertminderung.' },
            { name: 'Beweissicherung', description: 'Fotodokumentation und Sicherung relevanter Unfalldaten.' },
        ],
        faq: [
            {
                question: 'Was sollte ich nach einem Unfall zuerst tun?',
                answer: 'Sichern Sie die Unfallstelle, dokumentieren Sie den Schaden mit Fotos und melden Sie sich möglichst früh, damit die Beweissicherung sauber erfolgen kann.',
            },
            {
                question: 'Wer bezahlt das Unfallgutachten?',
        ...
        breadcrumbs: [
            { name: 'Startseite', path: '/' },
            { name: 'Unfallgutachten Bonn', path: '/unfallgutachten-bonn/' },
        ],
    },
    hauptuntersuchungBonn: {
        ...
        sections: [
            ...
            {
                id: 'eintragungen',
                title: 'Eintragungen nach technischen Änderungen',
                text: 'Umbauten und technische Änderungen müssen je nach Umfang geprüft und eingetragen werden. Wir beraten Sie zu leichten und umfangreicheren Änderungen.',
            },
            {
                id: 'gasanlagenpruefung',
                title: 'Gasanlagenprüfung',
                text: 'Fahrzeuge mit Gasanlage benötigen eine gesonderte Prüfung. Dazu gehören je nach Fahrzeug auch Prüfungen für Wohnmobile nach G607 und Boote nach G608.',
            },
            {
                id: 'vollabnahme',
                title: 'Vollabnahme und Importfahrzeuge',
                text: 'Importfahrzeuge oder lange stillgelegte Fahrzeuge benötigen häufig eine neue Betriebserlaubnis. Wir unterstützen Sie mit technischer Erfahrung und strukturierter Prüfung.',
            },
        ],
        services: [
        ...
        faq: [
            {
                question: 'Wann ist die Hauptuntersuchung fällig?',
                answer: 'Der nächste HU-Termin steht auf der Prüfplakette und in der Zulassungsbescheinigung. Wenn Sie unsicher sind, können Sie uns vorab kontaktieren.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Die HU-Öffnungszeiten sind Montag bis Freitag von 09:00 bis 17:00 Uhr und Samstag von 09:00 bis 13:00 Uhr.',
            },
        ],
        breadcrumbs: [
            { name: 'Startseite', path: '/' },
            { name: 'Hauptuntersuchung TÜV Bonn', path: '/hauptuntersuchung-tuev-bonn/' },
        ],
    },
};
